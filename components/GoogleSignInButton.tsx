...
export default function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      className="flex h-12 w-full items-center justify-center gap-2 rounded-full bg-accent text-base font-medium text-white transition-opacity disabled:opacity-60"
    >
      {pending ? (
        <span
          aria-hidden
