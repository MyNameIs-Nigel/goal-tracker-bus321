...
| [H9](#h9-turn-on-branch-protection-and-set-the-preview-env-vars) | Turn on branch protection, the merge settings, and the Vercel env vars | Phase 0 | 5 min | ✅ 2026-09-16 — Neon branching **on** |
